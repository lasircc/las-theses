class GenealogyID ():
    def __init__ (self,genID=''):
        ...
        self._tissueTypeDict = {'TUM':'tumor', 'LNG':'lung', 'LIV':'liver', 'GUT':'gut', 'BLD':'blood', 'MLI':'liver mets', 'MBR':'brain mets', 'MLN':'lung mets','SPL':'spleen'}
    ...
    def getCaseTissue(self):
        return self.getCase() + self.getTissue()
    ...
    def getSamplePassagge(self):
        return self._genID[self._indexes['samplePassage'][0]:self._indexes['samplePassage'][0]+self._indexes['samplePassage'][1]]

    def getSample(self):
        return self.getCaseTissue() + self.getSampleVector() + self.getLineage() + self.getSamplePassagge()
    ...
    def getTillPassage(self):
        #return self._genID[self._indexes['origin'][0]:self._indexes['mouse'][0]+self._indexes['mouse'][1]]
        return self._genID[self._indexes['origin'][0]:self._indexes['mouse'][0]]
        
    def getLongPrefix(self):
        #return self._genID[self._indexes['origin'][0]:self._indexes['tissueType'][0]+self._indexes['tissueType'][1]]
        return self._genID[self._indexes['origin'][0]:self._indexes['mouse'][0]+self._indexes['mouse'][1]]
