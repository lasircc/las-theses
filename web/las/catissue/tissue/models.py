...
def buildSemanticNode(label, nodeType, nextSemanticLevel, nodes, dateAl):
    ...
    if nodeType == 'Aliquot':
        ...
        elif genid.getSampleVector() in ['A','S','O','T']:
...
class ProtocolHamilton(models.Model):
    ...
    vol_kit_std=models.FloatField(blank=True,null=True)
    vol_taken_std=models.FloatField(blank=True,null=True)
    vol_dilution_std=models.FloatField(blank=True,null=True)
