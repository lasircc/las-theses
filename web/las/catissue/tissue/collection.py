    ...
    if request.method=='POST':
        ...
        try:           
            ...
            if 'salva' in request.POST:
                ...
                print 'work group coll_save is:',workingGroup
...
def SaveExternAliquots(request):
    if request.method=='POST':
        ...
        try:
            ...
            lislocalid=[]
            workingGroup=request.POST.get('wg')
            print 'work group save_ext_aliquots is:',workingGroup
            listawg=[workingGroup]
            ...
            if 'salva_nuova' in request.POST:
                ...
                listaaliq=json.loads(request.POST.get('dati'))
                print 'listaaliq save_extern_aliquots nuova is:',listaaliq
            ...
            if 'esistente' in request.POST:
                ...
                listaaliq=json.loads(request.POST.get('dati'))
                print 'listaaliq save_ext_aliquots esistente is:',listaaliq
...
def CellLineSave(request):
    if request.method=='POST':
        ...
        try:
            ...
            workingGroup=request.POST.get('wg')
            print 'work group cellline_save is:',workingGroup
            listawg=[workingGroup]
                ...
                for i in range(1,len(linee)):
                    if linee[i]!='\n':
                        ...
                        if tum==None:
                            ...
                            print 'colltype is: ',ltum
                            print 'didnt find ',val[0],'in ',listum
                            if len(ltum)==0:
                                raise ErrorDerived('Error in line '+str(i+1)+': collection type unknown')
                            else:
                                tum=ltum[0]
                                listum.append(tum)
                                print 'but added to the list'
                        ...
                        for s in lisprot:
                            if s.name.lower()==val[5].strip().lower():
                                ...
                                break
                        if prot==None:
                            print 'didnt find ',val[5],'in ',lisprot
                        ...
                        if tess==None:
                            ...
                            print 'didnt find ',val[7],'in ',listess
                            print 'ltess',ltess
                            if len(ltess)==0:
            ...
            if 'file_batch' in request.FILES:
                ...
                for i in range(1,len(linee)):
                    if linee[i]!='\n':
                        ...
                        elif vettore.abbreviation=='S' or vettore.abbreviation=='A' or vettore.abbreviation=='O' or vettore.abbreviation=='T':
                        ...
                        if tip=='whole blood' or tip=='pbmc' or tip=='plasma' or tip=='pax tube' or tip=='urine' or tip=='frozen sediments' or tipoal.type=='Derived' or ((vettore.abbreviation in ['A','S','O','T']) and tip=='viable'):
                            #per questi tipi di campioni ha senso mettere il volume
                        ...
                        if tip=='pbmc' or ((vettore.abbreviation in ['A','S','O','T']) and tip=='viable') or ((vettore.abbreviation in ['A','S','O','T']) and tip=='snap frozen'):
...
def BatchCollectionSave(request):
    if request.method=='POST':
        ...
        try:
            ...
            print 'work group batch_coll_save is:',workgr
                ...
                for diz in listot:
                    ...
                    if len(laliquota)==0:
                        ...
                        if derivato==1:
                            ...
                            conta=''
                        elif tip=='whole blood' or tip=='pbmc' or tip=='plasma' or tip=='pax tube' or tip=='urine' or tip=='frozen sediments' or ((vettore in['A','S','O','T']) and tip=='viable') or ((vettore in['A','S','O','T']) and tip=='snap frozen'):
                            if volu!='':
                                featvol=Feature.objects.get(idAliquotType=tipoaliquota,name='Volume')
                                aliqfeaturevol=AliquotFeature(idAliquot=a,
                                                           idFeature=featvol,
                                ...
                                print 'featu volume',aliqfeaturevol
                            if conta!='' and (tip =='pbmc' or ((vettore in['A','S','O','T']) and tip=='viable') or ((vettore in['A','S','O','T']) and tip=='snap frozen')):
                                featconta=Feature.objects.get(Q(idAliquotType=tipoaliquota)&Q(name='Count'))
                                aliqfeatureconta=AliquotFeature(idAliquot=a,
                                                           idFeature=featconta,
                                                           value=conta)
...
def SaveParameters(request):
    ...
    if request.method=='POST':        
        try:
            ...
            if 'salva' in request.POST:
                listaaliq=json.loads(request.POST.get('dati'))
                print 'listaaliq save_params is:',listaaliq
